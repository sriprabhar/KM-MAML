...
BASE_PREDICTIONS_PATH=${EXPERIMENT_PATH}'/'${MODEL}'/results_unseen_adapt_km_only_30/'

REPORT_PATH=${EXPERIMENT_PATH}'/'${MODEL}'/results_unseen_adapt_km_only_30/'
...
python evaluate_slicewise_adaptkmonly.py --base-target-path ${BASE_TARGET_PATH} --base-predictions-path ${BASE_PREDICTIONS_PATH} --report-path ${REPORT_PATH} --evaluate_task_strings ${EVALUATE_TASK_STRINGS}
