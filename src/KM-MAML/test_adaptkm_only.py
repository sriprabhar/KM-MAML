        ...
        for test_task,_ in zip(test_task_mini_batch[0],test_task_mini_batch[1]):
            ...
            while True:
                ...
                for gd_steps,test_spt_data_batch in enumerate(test_support_loader[test_task]):
                    ...
                    test_spt_fs_pred = model(test_spt_us_imgs, test_spt_ksp_imgs, test_spt_ksp_mask,task_down_modulation_weights, task_latent_modulation_weights,task_up_modulation_weights)
            ...
            with torch.no_grad(): # this is added to ensure that gradients do not occupy the gpu mem
                ...
                test_qry_fs_pred = model(test_qry_us_imgs,test_qry_ksp_imgs,test_qry_ksp_mask, qry_task_down_modulation_weights, qry_task_latent_modulation_weights, qry_task_up_modulation_weights)
