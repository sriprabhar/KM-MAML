...
if __name__ == '__main__':
    ...
    parser.add_argument('--acc-factor', type=pathlib.Path, required=True,
                        help='acc factor string')
    parser.add_argument('--mask-type', type=pathlib.Path, required=True,
                        help='mask type  string')
    parser.add_argument('--dataset-type', type=pathlib.Path, required=True,
                        help='data type string')
    ...
    csv_path     = args.report_path / 'metrics_{}_{}_{}.csv'.format(args.dataset_type, args.mask_type, args.acc_factor)
